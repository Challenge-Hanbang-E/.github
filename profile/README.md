...
## 프로젝트 소개
약 180만개 이상의 데이터에서 매일 1만개의 신상품의 데이터들이 추가되는 이커머스 사이트
...
<table>
  ...
  <tr> 
    <td align="center"><a href="https://github.com/yejin0718">김예진</a></td>
    <td align="center"><a href="https://github.com/tjvm0877">김재현</a></td>
    <td align="center"><a href="https://github.com/seunGit">민승기</a></td>
    <td align="center"><a href="https://github.com/m1naworld">송민아</a></td>
    <td align="center"><a href="https://github.com/yanJuicy">이한주</a></td>
  </tr>
</table>
...
### 🔎 상품 검색
- 1초 이내의 상품 검색 응답(목표로 했던 Latency 값 달성)
- `판매량 순`, `가격 낮은순`, `가격 높은순` 정렬 제공

### 📦 상품 주문 
- 대규모 트래픽에서도 동시성 문제 없이 주문 처리 
